"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Maintainer: 
"       Not another rainbow shitting unicorn
"
" Version: 1.1
"
" Forked_from:: 
...
if has("autocmd")
	autocmd BufWritePre *.php,*.txt,*.js,*.py,*.wiki,*.sh,*.coffee :call CleanExtraSpaces()
endif
...
" Quickly refresh file
map <leader>r :e<cr>

" Quickly refresh file without saving
map <leader>r! :e!<cr>
...
map <leader>y :setlocal paste!<cr>
